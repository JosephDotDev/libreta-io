...
function closeAll(){
  ...
  ['slash-menu','bk-menu','pm-sel','pm-dp','pm-ptp','prop-editor','color-pal','icon-picker','filter-pop','col-chooser','link-pop','idb-colpop','idb-filterpop','idb-rowmenu','idb-pop','fmt-color-pop','page-set-pop'].forEach(id=>document.getElementById(id)?.classList.remove('open'));
