...
function sbIsForeignDbEntry(d){
  ...
  if(d.meta&&d.meta.parent) return false;   // a page explicitly nested under another page stays in the tree
  return true;                               // any database entry lives in its database, not the loose pages tree
}
