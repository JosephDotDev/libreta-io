...
/* User-pickable swatch palette for tag/select options, kanban boards, calendar
   sources, etc. Refreshed to the brighter, more saturated Parra family so tags
   read as vivid panels. Index 0/4/6/7 line up with the section tokens
   (rose / green / blue / purple). Existing saved options keep their own stored
   hex — changing this only affects newly assigned colours. */
const PALETTE_COLORS=[
  '#E05572','#E8893E','#D4A83C','#8FCB52',
  '#5DC27A','#46B5A6','#4D88E8','#8B72D4',
  '#C45BC0','#D85858','#8A857E','#9A7355',
];
