...
/* Calendar is now a database view, not a rigid page: open the default database
   on the Databases page and switch it to the calendar view. */
function openCalendarView(){
  const t=getDefaultDb(); S.tblId=t.id;
  nav('tables'); openTbl(t.id);
  idbSetView('__pagedb__','calendar');
