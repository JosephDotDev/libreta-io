/* ═══════════════════════════════════════════════
   MATH / EQUATION BLOCKS  (KaTeX, lazy-loaded, self-hosted)
   A math block keeps its LaTeX source in block.content and renders it with
   KaTeX. KaTeX (script + stylesheet + fonts) lives in vendor/katex/ (v0.16.11,
   woff2 fonts only) and is loaded on demand the first time a math block is
   shown, so pages without math pay nothing. Self-hosted so math works offline
   and script-src stays 'self'. Editing shows a source textarea with a live
   preview above it; clicking a rendered equation re-opens the editor.
═══════════════════════════════════════════════ */
